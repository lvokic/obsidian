...
- [ANNS Section Writing Exemplars](wiki/analyses/anns-section-writing-exemplars/README.md) - Brutal 69-source Top 5 section-by-section audit and agent map of the best-written ANNS-related papers for abstract, introduction, background, motivation, architecture, method, optimization, implementation, evaluation, related work, and discussion/conclusion.
- [ANNS Top 3 Section Writing Navigator](wiki/analyses/anns-section-writing-exemplars/top3-section-writing-navigator.html) - Standalone HTML dashboard for navigating each paper section's best three writing exemplars, with PDF/source-note links, section targets, writing moves, and warnings.
- [ANNS Top 5 Section Excerpts](wiki/analyses/anns-section-writing-exemplars/top5-section-excerpts/README.md) - Boundary-cropped PDF excerpts for each section's best five paper exemplars, with Background & Motivation merged into one Top 5 folder and audited boundaries to avoid carrying whole unrelated sections.
