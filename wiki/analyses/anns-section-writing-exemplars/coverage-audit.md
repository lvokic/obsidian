...
This audit records the full candidate pool used for the May 29, 2026 refresh of [ANNS Section Writing Exemplars](README.md). I scanned all 65 current source-note pages in the vault. The table below states whether each paper was directly eligible for section-exemplar ranking, supporting only, or excluded as non-ANNS context.

## Coverage Categories

| Category | Meaning |
|---|---|
| Direct candidate | Evaluated for at least one section Top 3. |
| Supporting | Read as ANNS-related context, but not strong enough or not section-compatible enough for Top 3. |
...
|---|---|---|
| [SPFresh](../../source-notes/spfresh-2023.md) | Direct candidate | Top 3 for abstract, method, architecture, implementation, and evaluation. |
| [Starling](../../source-notes/starling-2024.md) | Direct candidate | Top 3 for abstract, introduction, background, motivation, method, evaluation, and discussion. |
| [OdinANN](../../source-notes/odinann-2026.md) | Direct candidate | New Top 3 for abstract, introduction, background, motivation, method, implementation, evaluation, related work, and discussion. |
| [VBASE](../../source-notes/vbase-2023.md) | Direct candidate | Top 3 for introduction, background, and related work; demoted from method because it is less pure ANNS systems method. |
| [Milvus](../../source-notes/milvus-2021.md) | Direct candidate | Top 3 for architecture and optimization; best source for batch/cache-aware vector DB execution. |
| [GustANN](../../source-notes/gustann-2025.md) | Direct candidate | Top 3 for motivation, implementation, related work, and discussion. |
| [FusionANNS](../../source-notes/fusionanns-2025.md) | Direct candidate | Top 3 for architecture; supporting for related work and reranking optimization. |
| [PQ Fast Scan](../../source-notes/pq-fast-scan-2015.md) | Direct candidate | Top 3 for optimization/execution layer; not a full system-section template. |
| [Flash Graph Indexing](../../source-notes/flash-graph-indexing-2025.md) | Direct candidate | Top 3 for optimization/execution layer; supporting for graph construction method. |
...
| [SymphonyQG](../../source-notes/symphonyqg-2024.md) | Supporting | Strong graph+SIMD source, but too many interacting mechanisms for a Top 3 writing template. |
...
| [RUMMY](../../source-notes/rummy-2024.md) | Supporting | Strong batching/pipeline source; no longer Top 3 after adding OdinANN and optimization category. |
...
| [SVFusion](../../source-notes/svfusion-2026.md) | Supporting | Interesting streaming GPU/CPU/disk system; not mature or clean enough for Top 3 writing models. |
...
| [Performance/Index-Size Dilemma](../../source-notes/performance-index-size-dilemma-2024.md) | Supporting | Strong systems framing source, but not enough section detail in current note for Top 3. |
...
| [TurboQuant](../../source-notes/turboquant-2025.md) | Supporting | Relevant to vector quantization; mixed KV-cache/retrieval scope makes it unsuitable for ANNS section Top 3. |
...
| [RNSG](../../source-notes/rnsg-2026.md) | Supporting | Range-filtered graph method; not enough maturity for Top 3. |
...
This audit covers every current source-note file under `wiki/source-notes/` as of 2026-05-29. The Top 3 section rankings are drawn only from papers that are direct ANNS systems/methods or highly relevant ANNS execution-layer papers. Adjacent database, CXL, SIMD, and KV-cache papers were considered but excluded from Top 3 unless they directly help explain an ANNS implementation section.
