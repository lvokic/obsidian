...
| 2 | [OdinANN](../../source-notes/odinann-2026.md) | 9.1 | Best direct-insert implementation story: fixed-size records, overprovisioned pages, update combining, approximate concurrency control, snapshots, and journaling all support the same claim. | The storage design trades extra SSD space and writes for stability. |
