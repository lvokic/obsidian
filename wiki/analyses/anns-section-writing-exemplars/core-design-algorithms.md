...
# Core Design / Algorithms Exemplars
...
| 3 | [VBASE](../../source-notes/vbase-2023.md) | 9.2 | Relaxed monotonicity is the cleanest formal design idea in the set because it changes the query interface rather than only optimizing an index. | It is less useful if your paper does not have a formal abstraction or semantic equivalence claim. |
